(() => {
  ...
  (a = void 0),
            ...
            for (let i = 0; i < p; i += 1) {
              ...
              if (
                ...
                if ("auto" === a.slidesPerView) {
                  ...
                  (S = (r - (a.slidesPerView - 1) * x) / a.slidesPerView),
                    a.roundLengths && (S = Math.floor(S)),
      ...
      var H = {
        attachEvents: function () {
          ...
          (e.onTouchStart = L.bind(e)),
            ...
            (e.onClick = D.bind(e)),
            i.touch && !G && (t.addEventListener("touchstart", N), (G = !0)),
            X(e, "on");
        },
    ...
    "object" == typeof exports && "undefined" != typeof module
      ...
      ? define(i)
      : ((a =
          "undefined" != typeof globalThis ? globalThis : a || self).Swiper =
          i());
  let r = document.querySelector(".header .search-form"),
    n = document.querySelector(".dark");
  document.querySelector("#search-btn").onclick = () => {
    r.classList.toggle("_active"),
      l.classList.remove("_active"),
      console.log(r);
  };
  let l = document.querySelector(".login-form");
  ...
  let o = document.querySelector(".contact-info");
  (document.querySelector("#info-btn").onclick = () => {
    o.classList.add("_active"), n.classList.add("_active");
  }),
    (document.querySelector("#close-contact-info").onclick = () => {
      o.classList.remove("_active"), n.classList.remove("_active");
    }),
  ...
  const d = new Swiper(".slider_main", {
      freeMode: !0,
      parallax: !0,
      loop: !0,
      breakpoints: {
        0: { spaceBetween: 20 },
        496: { slidesPerView: 1.5, spaceBetween: 20 },
        768: { slidesPerView: 2.2, spaceBetween: 20 },
        992: { slidesPerView: 3, spaceBetween: 20 },
        1268: { slidesPerView: 3.5, spaceBetween: 30 },
      },
    }),
    c = new Swiper(".slider_bg", {
      slidesPerView: 3.5,
      parallax: !0,
      spaceBetween: 30,
      loop: !0,
    });
  (d.controller.control = c),
